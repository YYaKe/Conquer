...
public class CalendarUtils {
    ...
    public static void addEvent(Context context, int year, int month, int day, int hour, int minute) {
        ...
        try {
            ...
            values.put(CalendarContract.Events.TITLE, "提醒");
    ...
    private static int checkCalendarAccounts(Context context) {
        ...
        Cursor userCursor = context.getContentResolver().query(Uri.parse(calanderURL), null,
                null, null, CalendarContract.Calendars.CALENDAR_ACCESS_LEVEL + " ASC ");
        try {
    ...
    private static long addCalendarAccount(Context context) {
        ...
        long accountID = Long.parseLong(result.getLastPathSegment());

        sb.append("新增日历账户成功！\n");
        sb.append("accountID:" + accountID).append("\n");
        sb.append("accountName:" + CALENDARS_ACCOUNT_NAME).append("\n");
        sb.append("\n");
        Log.i(TAG, "addCalendarAccount: " + sb);
